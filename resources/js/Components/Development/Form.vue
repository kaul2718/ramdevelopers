...
onMounted(() => {
    ...
    if (!props.form && props.updating && props.development) {
        form.value = {
            ...
            devt_active: props.development.devt_active !== undefined ? props.development.devt_active : true,
        ...
        <template #form>
            <details class="acordeon--seccion" open>
                ...
                <div class="contenido--seccion">
                    <div class="caja--doble">
                        ...
                        <div class="contenedor--input">
                            <select id="devr_id" v-model="form.devr_id" class="campo--input">
                                ...
                                <option v-for="developer in developers" :key="developer.devr_id"
                                    :value="String(developer.devr_id)">
                        ...
                        <div class="contenedor--input">
                            <select id="busiSta_id" v-model="form.busiSta_id" class="campo--input">
                                <option value="">Selecciona un estado</option>
                                <option v-for="state in businessStates" :key="state.busiSta_id"
                                    :value="String(state.busiSta_id)">
                                    {{ state.busiSta_name }}
                                </option>
                            </select>
                        ...
                        <div class="caja--doble">
                            <!-- Año de Entrega -->
                            <div class="contenedor--input">
                                <TextInput id="devt_delivery_year" v-model="form.devt_delivery_year" type="number"
                                    min="2020" class="campo--input" placeholder="Ej: 2025" />
                            ...
                            <!-- Destacado -->
                            <div class="contenedor--input">
                                <select id="devt_is_featured" v-model.number="form.devt_is_featured"
                                    class="campo--input">
                        ...
                        <div class="contenedor--input">
                            <select id="houTyp_id" v-model="form.houTyp_id" class="campo--input">
                                ...
                                <option v-for="type in housingTypes" :key="type.houTyp_id"
                                    :value="String(type.houTyp_id)">
                                    {{ type.houTyp_name }}
                                </option>
                            </select>
                        ...
                        <div class="caja--doble">
                            ...
                            <div v-if="updating" class="contenedor--input">
                                <select id="devt_active" v-model.boolean="form.devt_active" class="campo--input">
                                    <option :value="false">Inactivo</option>
                                    <option :value="true">Activo</option>
                                </select>
                                <InputLabel for="devt_active" value="Estado" />
                                <InputError :message="errors.devt_active" class="mt-2" />
                            </div>
                        </div>
                        <!-- Título -->
                        <div class="contenedor--input">
                    ...
                    <!-- Resumen Corto -->
                    <div class="contenedor--input">
                        <TextInput id="devt_short_description" v-model="form.devt_short_description"
                            class="campo--input" placeholder="Resumen breve del proyecto" rows="3" />
                    ...
                    <div class="caja--doble">
                        ...
                        <div class="contenedor--input">
                            <select id="ctry_id" v-model="form.ctry_id" class="campo--input">
                                ...
                                <option v-for="country in countries" :key="country.ctry_id"
                                    :value="String(country.ctry_id)">
                                    {{ country.ctry_name }}
                                </option>
                            </select>
                        ...
                        <div class="contenedor--input">
                            <select id="city_id" v-model="form.city_id" :disabled="!form.ctry_id" class="campo--input">
                                ...
                                <option v-for="city in filteredCities" :key="city.city_id"
                    ...
                    <div class="caja--doble">
                        ...
                        <div class="contenedor--input">
                            <select id="curr_id" v-model="form.curr_id" class="campo--input">
                                ...
                                <option v-for="currency in currencies" :key="currency.curr_id"
                                    :value="String(currency.curr_id)">
                        ...
                        <div class="caja--doble">
                            <!-- Precio Hasta -->
                            <div class="contenedor--input">
                                <TextInput id="devt_price_to" v-model="form.devt_price_to" type="number" min="0"
                                    step="0.01" class="campo--input" placeholder="Ej: 150000" />
                            ...
                            <!-- Precio Desde -->
                            <div class="contenedor--input">
                                <TextInput id="devt_price_from" v-model="form.devt_price_from" type="number" min="0"
                                    step="0.01" class="campo--input" placeholder="Ej: 50000" />
                        ...
                        <!-- Tipo de Honorarios -->
                        <div class="contenedor--input">
                            <select id="devt_estimated_profit_is_percentage"
                                v-model.boolean="form.devt_estimated_profit_is_percentage" class="campo--input">
                        ...
                        <div class="contenedor--input">
                            <TextInput id="devt_estimated_profit" v-model="form.devt_estimated_profit" type="number"
                                :min="form.devt_estimated_profit_is_percentage ? 1 : 0"
                                :max="form.devt_estimated_profit_is_percentage ? 100 : undefined" step="0.01"
                                class="campo--input"
                                :placeholder="form.devt_estimated_profit_is_percentage ? 'Ej: 25 (1-100)' : 'Ej: 20000'" />
                            <InputLabel for="devt_estimated_profit"
                                :value="form.devt_estimated_profit_is_percentage ? 'Honorarios (%)' : 'Honorarios ($)'" />
            ...
            <details class="acordeon--seccion">
                ...
                <div class="contenido--seccion">
                    <div class="caja--doble">
                        <div class="caja--doble">
                            <div class="contenedor--input">
                                <TextInput id="devt_bedrooms" v-model="form.devt_bedrooms" type="number" min="0"
                                    class="campo--input" placeholder="Ej: 3" />
                                <InputLabel for="devt_bedrooms" value="Número de Dormitorios" />
                                <InputError :message="errors.devt_bedrooms" class="mt-2" />
                            </div>

                            <div class="contenedor--input">
                                <TextInput id="devt_storage_rooms" v-model="form.devt_storage_rooms" type="number"
                                    min="0" class="campo--input" placeholder="Ej: 2" />
                        ...
                        <div class="caja--doble">
                            <div class="contenedor--input">
                                <TextInput id="devt_parking_spaces" v-model="form.devt_parking_spaces" type="number"
                                    min="0" class="campo--input" placeholder="Ej: 2" />
                            ...
                            <div class="contenedor--input">
                                <TextInput id="devt_terraces" v-model="form.devt_terraces" type="number" min="0"
                        ...
                        <div class="caja--doble">
                            <div class="contenedor--input">
                                <TextInput id="devt_swimming_pools" v-model="form.devt_swimming_pools" type="number"
                                    min="0" class="campo--input" placeholder="Ej: 1" />
                                <InputLabel for="devt_swimming_pools" value="Piscina" />
                                <InputError :message="errors.devt_swimming_pools" class="mt-2" />
                            </div>

                            <div class="contenedor--input">
                                <TextInput id="devt_children_areas" v-model="form.devt_children_areas" type="number"
                                    min="0" class="campo--input" placeholder="Ej: 1" />
                        ...
                        <div class="caja--doble">
                            ...
                            <div class="contenedor--input">
                                <TextInput id="devt_elevators" v-model="form.devt_elevators" type="number" min="0"
                                    class="campo--input" placeholder="Ej: 2" />
