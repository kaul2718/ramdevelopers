...
<template>
    ...
    <div v-if="isModal" class="space-y-6">
        ...
        <div>
            ...
            <TextInput id="devr_legal_name" v-model="form.devr_legal_name" type="text" autocomplete="off"
                class="mt-1 block w-full" placeholder="Ej: TechDev Solutions S.A.">
            </TextInput>
        ...
        <div>
            ...
            <TextInput id="devr_email_contact" v-model="form.devr_email_contact" type="email" autocomplete="email"
                class="mt-1 block w-full" placeholder="contacto@ejemplo.com">
            </TextInput>
        ...
        <div>
            ...
            <TextInput id="devr_phone_contact" v-model="form.devr_phone_contact" type="text" autocomplete="tel"
                class="mt-1 block w-full" placeholder="+1 (555) 123-4567">
            </TextInput>
        ...
        <div>
            ...
            <TextInput id="devr_website" v-model="form.devr_website" type="url" autocomplete="url"
                class="mt-1 block w-full" placeholder="https://www.ejemplo.com">
            </TextInput>
        ...
        <div v-if="updating">
            ...
            <select id="devr_active" v-model="form.devr_active" class="mt-1 block w-full border-gray-300 rounded-md">
