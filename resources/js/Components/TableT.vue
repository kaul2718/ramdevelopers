  ...
  <div class="flex flex-col">
    <div class="overflow-x-auto">
      <div class="min-w-full inline-block align-middle">
        <!-- Search Input -->
        <div class="relative text-gray-500 focus-within:text-gray-900 mb-4" v-if="showSearch">
          ...
          <table class="min-w-full rounded-xl">
            ...
            <tbody class="divide-y divide-gray-300">
              ...
              >
                ...
                <!-- Actions Column -->
                <td v-if="showActions" class="p-5">
                  <div class="flex items-center gap-1">
                    <!-- Edit Button -->
                    <button
                      v-if="showEditButton"
                      @click="$emit('edit', row)"
                      class="p-2 rounded-full group transition-all duration-500 flex items-center hover:bg-indigo-50"
                    ...
                    <button
                      ...
                      class="p-2 rounded-full group transition-all duration-500 flex items-center hover:bg-red-50"
                    ...
                    >
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="stroke-black" d="M10.0161 14.9897V15.0397M10.0161 9.97598V10.026M10.0161 4.96231V5.01231" stroke="black" stroke-width="2.5" stroke-linecap="round"/>
                      </svg>
                    </button>
              ...
              <tr v-if="filteredRows.length === 0">
                <td :colspan="columns.length + (showActions ? 1 : 0)" class="p-5 text-center text-gray-500">
                  {{ emptyMessage }}
                </td>
              </tr>
            </tbody>
...
const props = defineProps({
  ...
  searchableFields: {
    type: Array,
    default: () => [] // Si está vacío, busca en todos los campos
  },
...
// Emits
const emit = defineEmits(['edit', 'delete', 'more', 'search'])
...
const filteredRows = computed(() => {
  ...
  return props.rows.filter(row => {
    // Si se especifican campos de búsqueda
