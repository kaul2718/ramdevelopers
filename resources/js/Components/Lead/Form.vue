    ...
    <FormSection @submitted="handleSubmit">
        ...
        <template #form>
            <div class="caja--doble">
                ...
                <div class="contenedor--input">
                    <TextInput id="lead_client_name" v-model="form.lead_client_name" type="text" autocomplete="off"
                        placeholder=" " class="campo--input" />
                ...
                <!-- Email -->
                <div class="contenedor--input">
                    <TextInput id="lead_client_email" v-model="form.lead_client_email" type="email" autocomplete="off"
                        placeholder=" " class="campo--input" />
                ...
                <!-- Teléfono -->
                <div class="contenedor--input">
                    <TextInput id="lead_client_phone" v-model="form.lead_client_phone" type="tel" autocomplete="off"
                        placeholder=" " class="campo--input" />
                ...
                <!-- Idioma -->
                <div class="contenedor--input">
                    <select id="lead_language" v-model="form.lead_language" placeholder="" class="campo--input">
                ...
                <!-- País -->
                <div class="contenedor--input">
                    <select id="ctry_id" v-model="form.ctry_id" placeholder=" " class="campo--input">
                ...
                <!-- Desarrollo -->
                <div class="contenedor--input">
                    <select id="devt_id" v-model="form.devt_id" placeholder=" " class="campo--input">
                ...
                <div class="caja--doble">
                    <!-- Fuente del Lead -->
                    <div class="contenedor--input">
                        <select id="leadSou_id" v-model="form.leadSou_id" placeholder=" " class="campo--input">
                            <option value="" disabled>Selecciona un origen</option>
                            <option v-for="source in sources" :key="source.leadSou_id"
                                :value="String(source.leadSou_id)">
                                {{ source.leadSou_name }}
                            </option>
                        </select>
                    ...
                    <!-- Estado del Lead -->
                    <div class="contenedor--input">
                        <select id="leadSta_id" v-model="form.leadSta_id" placeholder=" " class="campo--input">
                            <option value="" disabled>Selecciona un estado</option>
                            <option v-for="status in statuses" :key="status.leadSta_id"
                                :value="String(status.leadSta_id)">
                                {{ status.leadSta_name }}
                            </option>
                        </select>
                ...
                <!-- Usuario Responsable -->
                <div class="contenedor--input">
                    <select id="user_id" v-model="form.user_id" placeholder=" " class="campo--input">
                ...
                <div class="contenedor--input" style="grid-column: 1 / -1;">
                    <TextInput id="lead_message" v-model="form.lead_message" rows="5" placeholder=" "
                        class="campo--input"></TextInput>
        ...
        <template #actions>
            <PrimaryButton :disabled="isSubmitting">
                <template #texto--boton>{{ isSubmitting ? 'Guardando...' : (updating ? 'Actualizar' : 'Crear')
                    }}</template>
