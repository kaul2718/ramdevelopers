...
<template>
    <DialogModal :show="show" @close="closeModal" max-width="2xl">
        <template #content v-if="commercialStatus">
            <div class="space-y-6">
                <!-- Título -->
                <div class="pb-4 border-b">
                    <h3 class="modal-title">Información del Estado Comercial</h3>
                </div>
                ...
                <div>
                    ...
                    <div class="modal-grid">
                        <div>
                            ...
                            <p class="modal-label">{{ commercialStatus.commSta_code }}</p>
                        </div>

                        <div>
                            <p class="modal-value">Nombre</p>
                            <p class="modal-label">{{ commercialStatus.commSta_name }}</p>
                        </div>

                        <div>
                            <p class="modal-value">Estado</p>

                            <p v-if="commercialStatus.commSta_active"
                        ...
                        <div>
                            ...
                            <p class="modal-label">
                                {{ commercialStatus.commSta_description || 'N/A' }}
                            </p>
                        </div>
                    </div>
                </div>
