...
<template>
    <DialogModal :show="show" @close="closeModal" max-width="2xl">
        <template #content v-if="leadStatus">
            <div class="space-y-6">
                <!-- Encabezado -->
                <div class="pb-4 border-b">
                    <h3 class="modal-title">{{ leadStatus.leadSta_name }}</h3>
                    <p class="modal-subtitle">{{ leadStatus.leadSta_code }}</p>
                    <div class="mt-2">
                        <span v-if="leadStatus.leadSta_active" 
                ...
                <div>
                    ...
                    <div class="modal-grid">
                        <div>
                            ...
                            <p class="modal-value">{{ leadStatus.leadSta_code }}</p>
                        </div>
                        <div>
                            <p class="modal-label">Nombre</p>
                            <p class="modal-value">{{ leadStatus.leadSta_name }}</p>
                        </div>
                        <div class="col-span-2">
                            <p class="modal-label">Descripción</p>
                            <p class="modal-value">{{ leadStatus.leadSta_description || 'No especificada' }}</p>
                        </div>
                    </div>
                </div>
            </div>
