...
const deleteBusinessState = (id) => {
    if (confirm("¿Seguro que deseas eliminar este estado?")) {
        router.delete(route("businessstate.destroy", id));
    }
};
</script>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="p-6 bg-white border-border-gray-200">
                    <div class="flex justify-end pr-2"
                        ...
                        <Link :href="route('businessstate.create')"
                                        ...
                                        <tbody class="divide-y divide-gray-300 ">
                                            <tr v-for="item in business_states.data" :key="item.busiSta_id"
                                                ...
                                                <td class="flex p-5 items-center gap-0.5">
                                                    <Link :href="route('businessstate.edit', item.busiSta_id)"
                                                    ...
                                                    <Link @click="deleteBusinessState(item.busiSta_id)"
