...
<template>
    <AppLayout title="Estados del proyecto">
        <HeaderBody titulo-body="Estados del Proyecto" permisos="create business state" nombre-btn="Crear nuevo"
        ...
        <!-- ViewModal -->
        <ViewModal :show="showViewModal" :businessState="selectedBusinessState" @close="closeViewModal" />

        <!-- EditModal -->
        <EditModal :show="showEditModal" :businessState="selectedBusinessState" @close="closeEditModal" />

        <!-- ConfirmModal -->
        <ConfirmModal :show="showDeleteConfirm" title="Eliminar Estado del Proyecto"
