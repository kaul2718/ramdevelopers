    ...
    <AppLayout title="Ciudades">
        ...
        <div class="caja--tabla">
            <table>
                ...
                <tbody>
                    <tr v-for="item in cities.data" :key="item.city_id" @click="openViewModal(item)">
                        <td>{{ item.city_id }}</td>
                        ...
                        <td>
                            <div :class="['px-2 rounded-md flex justify-center w-fit items-center gap-2', item.city_active ? 'bg-emerald-50 text-emerald-600' : 'bg-red-50 text-red-600']">
                                <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="3" cy="3" r="3" :fill="item.city_active ? '#059669' : '#dc2626'" />
                                </svg>
                                <span>{{ item.city_active ? 'Activo' : 'Inactivo' }}</span>
                            </div>
                        </td>                        
