...
const deleteDocumentType = (id) => {
    if (confirm("¿Seguro que deseas eliminar este tipo de documento?")) {
        router.delete(route("documenttype.destroy", id));
    }
};
</script>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="p-6 bg-white border-border-gray-200">
                    <div class="flex justify-end pr-2" v-if="$page.props.user.permissions.includes('create document types')">
                        <Link 
                            :href="route('documenttype.create')"
                                        ...
                                        <tbody class="divide-y divide-gray-300">
                                            <tr 
                                                ...
                                                <td class="flex p-5 items-center gap-0.5">
                                                    <Link :href="route('documenttype.edit', item.docTyp_id)"
                                                    ...
                                                    <Link @click="deleteDocumentType(item.docTyp_id)"
