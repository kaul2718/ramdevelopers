...
<script setup>
    ...
    import EditModal from '@/Components/LeadStatus/EditModal.vue';
...
<template>
    <AppLayout title="Estados lead">
        ...
        <!-- Modal de Información del Lead Status -->
        <ViewModal 
        ...
        <!-- Modal de Creación de Lead Status -->
        <CreateModal :show="showCreateModal" @close="showCreateModal = false" />

        <!-- Modal de Edición de Lead Status -->
        <EditModal
            :show="showEditModal"
            :lead-status="selectedLeadStatus"
            @close="closeLeadStatusModal"
