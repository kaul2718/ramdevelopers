...
<script setup>
    ...
    import EditModal from '@/Components/LeadSource/EditModal.vue';
...
<template>
    <AppLayout title="Origen de lead">
        ...
        <!-- Modal de Información del Lead Source -->
        <ViewModal 
        ...
        <!-- Modal de Creación de Lead Source -->
        <CreateModal :show="showCreateModal" @close="showCreateModal = false" />

        <!-- Modal de Edición de Lead Source -->
        <EditModal
            :show="showEditModal"
            :lead-source="selectedLeadSource"
            @close="closeLeadSourceModal"
