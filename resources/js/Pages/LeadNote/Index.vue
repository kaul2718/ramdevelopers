...
<template>
    <AppLayout>
        <template #header>
            <h1 class="font-semibold text-xl text-gray-800 leading-tight">Notas de Leads</h1>
        </template>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                    ...
                                    <table class="w-full rounded-xl">
                                        ...
                                        <tbody class="divide-y divide-gray-300">
                                            <tr 
                                                ...
                                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                    <Link :href="route('lead.show', item.lead?.lead_id)" class="text-indigo-600 hover:text-indigo-900">
                                                        {{ item.lead?.lead_client_name }}
                                                    </Link>
                                                </td>
                                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                ...
                                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                    <div :class="[
                                                        ...
                                                        item.leadNot_active ? 'bg-emerald-50 text-emerald-600' : 'bg-red-50 text-red-600'
                                                    ]">
                                                        <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <circle cx="3" cy="3" r="3" :fill="item.leadNot_active ? '#059669' : '#dc2626'" />
                                                        </svg>
                                                        <span class="font-semibold text-xs">
                                                            {{ item.leadNot_active ? 'Activo' : 'Inactivo' }}
                                                        </span>
                                                    </div>
                                                </td>
                                                <td class="flex p-5 items-center gap-0.5">
                                                    <Link :href="route('leadnote.show', item.leadNot_id)"
                                                        ...
                                                        <svg class="cursor-pointer" width="20" height="20"
                                                            ...
                                                            <path class="fill-blue-500 group-hover:fill-white"
                                                                d="M12 5C7 5 2.73 8.11 1 12.46c1.73 4.35 6 7.54 11 7.54s9.27-3.19 11-7.54c-1.73-4.35-6-7.46-11-7.46zM12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm0-7c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z">
                                                            </path>
                                                        </svg>
                                                    </Link>
                                                    <Link :href="route('leadnote.edit', item.leadNot_id)"
                                                    ...
                                                    <Link @click="deleteLeadNote(item.leadNot_id)"
                ...
                <!-- Pagination -->
                <div v-if="leadNotes.links" class="mt-6 flex justify-center gap-2">
                    <Link 
                        v-for="link in leadNotes.links" 
                        :key="link.label"
                        :href="link.url || '#'"
                        class="px-3 py-2 text-sm border rounded"
                        :class="{
                            'bg-indigo-600 text-white border-indigo-600': link.active,
                            'border-gray-300 text-gray-700 hover:bg-gray-50': !link.active && link.url,
