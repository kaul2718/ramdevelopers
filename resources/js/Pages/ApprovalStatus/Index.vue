...
<template>
    <AppLayout title="Estado Aprobacion">
        <HeaderBody titulo-body="Estados de aprobación - Proyectos" permisos="create approval status" nombre-btn="Crear nuevo" @create="showCreateModal = true"/>
            ...
            <table>
                ...
                <tbody>
                    <tr v-for="item in approval_statuses.data" :key="item.apvSta_id">
                        <td>{{ item.apvSta_id }}</td>
                        <td>{{ item.apvSta_name }}</td>
                        <td>{{ item.apvSta_code }}</td>
                        <td>{{ item.apvSta_description }}</td>
                        <td>
                        ...
                        <td class="botonera--tabla">
                            <button @click="openApprovalStatusModal(item)" class="btn--tipo1" title="Ver información">
                            ...
                            <button @click="openApprovalStatusModalForEdit(item)" class="btn--tipo1" title="Editar campo" v-if="$page.props.user.permissions.includes('update approval status')">
                                <svg class="size-5" viewBox="0 0 20 20" fill="CurrentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button @click="openDeleteConfirm(item)"class="btn--tipo2" title="Eliminar campo" v-if="$page.props.user.permissions.includes('delete approval status')">
                                <svg class="size-5" viewBox="0 0 20 20" fill="CurrentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Paginación -->
        <Pagination :objPage="approval_statuses" />
