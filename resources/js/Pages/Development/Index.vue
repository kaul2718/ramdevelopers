                                ...
                                <div class="overflow-x-auto w-full border rounded-lg border-gray-300">
                                    <table class="w-full rounded-xl">
                                        ...
                                        <tbody class="divide-y divide-gray-300">
                                            <tr 
                                                v-for="item in developments.data" 
                                                :key="item.devt_id"
                                                ...
                                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                    {{ item.city?.city_name || 'Sin ciudad' }}
                                                </td>
                                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                ...
                                                <td class="flex p-5 items-center gap-0.5">
                                                    <Link
                                                        :href="route('development.edit', item.devt_id)"
                                                        v-if="$page.props.user.permissions.includes('update development')"
                                                    ...
                                                    <Link :href="route('development.show', item.devt_id)"
                                                        class="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-blue-600 flex item-center">
                                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path class="stroke-blue-600 group-hover:stroke-white"
                                                                d="M12 5C7 5 2.73 8.11 1 12.46c1.73 4.35 6 7.54 11 7.54s9.27-3.19 11-7.54C21.27 8.11 17 5 12 5m0 9c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3"
                                                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                                stroke-linejoin="round"></path>
                                                        </svg>
                                                    </Link>
                                                    <Link @click="deleteDevelopment(item.devt_id)"
                                                        v-if="$page.props.user.permissions.includes('delete development')"
                    ...
                    <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">
                                Mostrando
                                <span class="font-medium">{{ developments.from }}</span>
                                a
                                <span class="font-medium">{{ developments.to }}</span>
                                de
                                <span class="font-medium">{{ developments.total }}</span>
                                resultados
                            </p>
                        </div>
                    </div>
