    ...
    <AppLayout title="Proyectos">
        ...
        <div class="caja--tabla">
            <table>
                ...
                <tbody>
                    <tr v-for="item in developments.data" :key="item.devt_id" @click="goToShow(item.devt_id)">
                        <td style="padding: 0;">
                        ...
                        <td>
                            <div class="botonera--tabla">
                                <button @click.stop="goToEdit(item.devt_id)" class="btn--tipo1" title="Editar campo" v-if="$page.props.user.permissions.includes('update development')">
                                ...
                                <button @click.stop="deleteDevelopment(item)"class="btn--tipo2" title="Eliminar campo" v-if="$page.props.user.permissions.includes('delete development')">
                                    <svg class="size-5" viewBox="0 0 20 20" fill="CurrentColor" xmlns="http://www.w3.org/2000/svg">
