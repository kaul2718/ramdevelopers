...
<template>
    <AppLayout title="Editar Desarrollo">
        ...
        <div class="bloque--horizontal">
            <h2></h2>
            <HeaderBody titulo-body="Documentos adjuntos" permisos="create users" nombre-btn="Agregar Archivo" @create="showFileModal = true"/>
            <div v-if="development.files && development.files.length > 0">
                <div class="caja--tabla">
                    <table>
                        <thead>
                            <tr>
                                <th>Nombre archivo</th><th>Tipo</th><th>Borrar</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="file in development.files" :key="file.devFile_id" @click="openFile(file)">
                                ...
                                <td class="botonera--tabla">
                                    <button @click.stop="confirmDelete(file.devFile_id, 'file')" class="btn--tipo2" title="Eliminar campo">
        ...
        <div class="bloque--horizontal">
            <h2></h2>
            <HeaderBody titulo-body="Galería de Imágenes" permisos="create users" nombre-btn="Agregar Imagen" @create="showImageModal = true"/> 
