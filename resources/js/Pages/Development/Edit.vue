...
<template>
    <AppLayout title="Editar Desarrollo">
        ...
        <details class="acordeon--seccion" style="margin-top: -1em;">
            <summary>
                <h3>Documentos adjuntos</h3>
            </summary>
            <div class="contenido--seccion">
                <div class="bloque--horizontal" style="margin-bottom: 0;">                    
                    <PrimaryButton @click="showFileModal = true" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" style="margin-top: -2em">
                        <template #texto--boton>Agregar Archivo</template>
                        <template #icono--boton>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                        </template>
                    </PrimaryButton>
                    <div v-if="development.files && development.files.length > 0" class="caja--tabla">
                        <table>
                            <thead>
                                <tr>
        ...
        <details class="acordeon--seccion" style="margin-top: 1em;">
            ...
            <div class="contenido--seccion">
                <div class="bloque--horizontal" style="margin-bottom: 0;">                    
                    <PrimaryButton @click="showImageModal = true" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" style="margin-top: -2em">
                        <template #texto--boton>Agregar Imagen</template>
                        <template #icono--boton>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                        </template>
                    </PrimaryButton>
                    <div v-if="development.images && development.images.length > 0" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" style="margin-top: 1em;">
