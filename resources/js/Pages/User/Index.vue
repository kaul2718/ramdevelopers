        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="p-6 bg-white border-border-gray-200">
                    <div class="flex justify-end pr-2" v-if="$page.props.user.permissions.includes('create users')">
                        <button
                                    ...
                                    <table class="w-full rounded-xl">
                                        ...
                                        <tbody class="divide-y divide-gray-300">
                                            <tr 
                                                ...
                                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                    <span v-if="item.usr_active" class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700">
                                                        Activo
                                                    </span>
                                                ...
                                                <td class="flex p-5 items-center gap-0.5">
                                                    ...
                                                    <button
                                                        @click="openUserModalForEdit(item)"
