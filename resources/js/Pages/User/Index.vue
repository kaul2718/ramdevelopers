                    ...
                    <tr v-for="item in users.data" :key="item.id" @click="openUserModal(item)">
                        ...
                        <td>
                            <div class="botonera--tabla">
                                <button @click.stop="openUserModalForEdit(item)" class="btn--tipo1" title="Editar campo" v-if="$page.props.user.permissions.includes('update users')">
                                ...
                                <button @click.stop="openDeleteConfirm(item)"class="btn--tipo2" title="Eliminar campo" v-if="$page.props.user.permissions.includes('delete users')">
                                    <svg class="size-5" viewBox="0 0 20 20" fill="CurrentColor" xmlns="http://www.w3.org/2000/svg">
