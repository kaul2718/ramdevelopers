...
<template>
    <AppLayout title="Paises">
        <HeaderBody titulo-body="Gestión de paises" permisos="create countries" nombre-btn="Crear nuevo" @create="showCreateModal = true"/>

        <div class="caja--tabla">
            <table>
                <thead>
                    <tr>
                        <th>Id</th><th>Nombre</th><th>Código</th><th>Estado</th><th>Acciones</th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="item in countries.data" :key="item.ctry_id">
                        ...
                        <td class="botonera--tabla">
                            <button @click="openCountryModal(item)" class="btn--tipo1" title="Ver información">
                            ...
                            <button @click="openCountryModalForEdit(item)" class="btn--tipo1" title="Editar campo" v-if="$page.props.user.permissions.includes('update countries')">
                                <svg class="size-5" viewBox="0 0 20 20" fill="CurrentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button @click="openDeleteConfirm(item)"class="btn--tipo2" title="Eliminar campo" v-if="$page.props.user.permissions.includes('delete countries')">
                                <svg class="size-5" viewBox="0 0 20 20" fill="CurrentColor" xmlns="http://www.w3.org/2000/svg">
