...
<script setup>
    ...
    import EditModal from '@/Components/Country/EditModal.vue';
    import ViewModal from '@/Components/Country/ViewModal.vue';
    ...
    const confirmDelete = () => {
        if (countryToDelete.value) {
            router.delete(route('countries.destroy', countryToDelete.value.ctry_id), {
                onSuccess: () => {
    ...
    <AppLayout title="Paises">
        ...
        <div class="caja--tabla">
            <table>
                ...
                <tbody>
                    <tr v-for="item in countries.data" :key="item.ctry_id" @click="openViewModal(item)">
                        <td>{{ item.ctry_id }}</td>
                        ...
                        <td class="botonera--tabla">
                            <button @click.stop="openEditModal(item)" class="btn--tipo1" title="Editar campo" v-if="$page.props.user.permissions.includes('update countries')">
                            ...
                            <button @click.stop="openDeleteConfirm(item)"class="btn--tipo2" title="Eliminar campo" v-if="$page.props.user.permissions.includes('delete countries')">
                                <svg class="size-5" viewBox="0 0 20 20" fill="CurrentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- ViewModal -->
        <ViewModal :show="showViewModal" :country="selectedCountry" @close="closeViewModal" />

        <!-- EditModal -->
        <EditModal :show="showEditModal" :country="selectedCountry" @close="closeEditModal" />
