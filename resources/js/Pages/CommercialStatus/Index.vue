...
const deleteCommercialStatus = (id) => {
    if (confirm("¿Seguro que deseas eliminar este estado?")) {
        router.delete(route("commercialstatus.destroy", id));
    }
};
</script>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="p-6 bg-white border-border-gray-200">
                    <div class="flex justify-end pr-2"
                        ...
                        <Link :href="route('commercialstatus.create')"
                            ...
                            <div class="block">
                                        ...
                                        <tbody class="divide-y divide-gray-300 ">
                                            <tr v-for="item in commercial_statuses.data" :key="item.commSta_id"
                                                ...
                                                <td class="flex p-5 items-center gap-0.5">
                                                    <Link :href="route('commercialstatus.edit', item.commSta_id)"
                                                    ...
                                                    <Link @click="deleteCommercialStatus(item.commSta_id)"
                                ...
                                <div
                                    ...
                                    <div class="flex flex-1 justify-between sm:hidden">
                                        <Link v-if="commercial_statuses.prev_page_url" :href="commercial_statuses.prev_page_url"
                                        ...
                                        <Link v-if="commercial_statuses.next_page_url" :href="commercial_statuses.next_page_url"
                                    ...
                                    <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                                        ...
                                        <div>
                                            <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm"
                                                ...
                                                <Link v-for="link in commercial_statuses.links.slice(1, -1)" :key="link.url"
                                                    :href="link.url"
                                                    :class="{
                                                        ...
                                                        'relative inline-flex items-center border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-50 focus:z-20': !link.active
                                                    }"
                                                    v-html="link.label">
                                                </Link>
                                                <Link v-if="commercial_statuses.next_page_url" :href="commercial_statuses.next_page_url"
