    ...
    <AppLayout title="Tipo de Proyecto">
        ...
        <div class="caja--tabla">
            <table>
                ...
                <tbody>
                    <tr v-for="item in commercial_statuses.data" :key="item.commSta_id" @click="openCommercialStatusModal(item)">
                        ...
                        <td class="botonera--tabla">
                            <button @click.stop="openCommercialStatusModalForEdit(item)" class="btn--tipo1" title="Editar campo" v-if="$page.props.user.permissions.includes('update commercial status')">
                            ...
                            <button @click.stop="openDeleteConfirm(item)"class="btn--tipo2" title="Eliminar campo" v-if="$page.props.user.permissions.includes('delete commercial status')">
                                <svg class="size-5" viewBox="0 0 20 20" fill="CurrentColor" xmlns="http://www.w3.org/2000/svg">
