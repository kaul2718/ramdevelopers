            ...
            <table>
                ...
                <tbody>
                    <tr v-for="item in commercial_statuses.data" :key="item.commSta_id" @click="openCommercialStatusModal(item)">
                        ...
                        <td>
                            <div :class="['px-2 rounded-md flex justify-center w-fit items-center gap-2', item.commSta_active ? 'bg-emerald-50 text-emerald-600' : 'bg-red-50 text-red-600']">
                                <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="3" cy="3" r="3" :fill="item.commSta_active ? '#059669' : '#dc2626'" />
                                </svg>
                                <span>{{ item.commSta_active ? 'Activo' : 'Inactivo' }}</span>
                            </div>
                        </td>
